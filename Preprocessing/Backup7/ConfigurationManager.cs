...
namespace Preprocessing
{
    public class ConfigurationManager
    {
        ...
        // Context target features to be included in test set or not
        public bool includeContextTargetFeaturesInTestSet;
                        ...
                        if (reader.HasAttributes)
                        {
                            ...
                            while (reader.MoveToNextAttribute())
                            {
                                switch (reader.Name)
                                {
                                    ...
                                    case "IncludeContextTargetFeaturesInTestSet":
                                        includeContextTargetFeaturesInTestSet = bool.Parse(reader.Value);
                                        break;
