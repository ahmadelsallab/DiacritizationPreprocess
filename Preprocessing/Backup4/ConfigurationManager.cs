...
namespace Preprocessing
{
    public class ConfigurationManager
    {
        ...
        public Hashtable mrfSuppressFeaturesHashTable = new Hashtable();
        ...
        public String trainPOSInputFormat;
        public String testPOSInputFormat;
                            ...
                            while (reader.MoveToNextAttribute())
                            {
                                switch (reader.Name)
                                {
                                    ...
                                    case "MrfSuppressFeature":
                                        mrfSuppressFeaturesHashTable.Add(reader.Value, "Suppress");
                                        break;
                                    ...
                                    case "TrainPOSInputFormat":
                                        trainPOSInputFormat = reader.Value;
                                        break;

                                    case "TestPOSInputFormat":
                                        testPOSInputFormat = reader.Value;
                                        break;
